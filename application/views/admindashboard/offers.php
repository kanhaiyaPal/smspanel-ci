			...
			<div class="panel-body">
				...
				<div class="collapse" id="addoffercollapse">
				  ...
				  <div class="row">
					...
					<div class="col-md-2"><input class="btn btn-primary" type="submit" name="addnotify" value="Add" /> &nbsp;<input class="btn btn-default" data-toggle="collapse" href="#addoffercollapse" type="button" value="Cancel" /></div>
				  </div>
				  <?php echo form_close(); ?>
				</div>
				...
				<div class="collapse" id="editoffercollapse">
				  ...
				  <div class="row">
					...
					<div class="col-md-10"><input type="hidden" name="offer_id" id="offer_id" value="" /></div>
					<div class="col-md-2"><input class="btn btn-primary" type="submit" name="addnotify" value="Edit" />&nbsp;<input class="btn btn-default" data-toggle="collapse" href="#editoffercollapse" type="button" value="Cancel" /></div>
				  </div>
				  <?php echo form_close(); ?>
				</div>
